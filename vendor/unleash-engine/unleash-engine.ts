import {
  ...
  FeatureInterface,
} from "../unleash-client-node/feature";
import { Context } from "../unleash-client-node/context";
import {
  defaultStrategies,
  Strategy,
  StrategyTransportInterface,
} from "../unleash-client-node/strategy";
import { selectVariant, Variant } from "../unleash-client-node/variant";
import { Constraint, Segment } from "../unleash-client-node/strategy/strategy";
...
export class ToggleEngine {
  ...
  constructor(rawFeatures: ClientFeaturesResponse | undefined) {
